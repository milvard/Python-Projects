...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # 2. Πόσο ξένο νόμισμα παίρνουμε συνολικά
    total_currency = budget / actual_rate
    
    # 3. Πόσα ολόκληρα χαρτονομίσματα χωράνε (ακέραια διαίρεση)
    number_of_bills = total_currency // denomination
    
    # 4. Επιστροφή της συνολικής αξίας των χαρτονομισμάτων ως ακέραιος
